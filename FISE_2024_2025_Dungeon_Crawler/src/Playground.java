...
//Lina: set new trap dimensions
            final int imageTrapWidth = imageTrap.getWidth(null);
            final int imageTrapHeight = imageTrap.getHeight(null);
            final int imageDoorWidth = imageTrap.getWidth(null);
            final int imageDoorHeight = imageTrap.getHeight(null);
                ...
                for (byte element : line.getBytes(StandardCharsets.UTF_8)) {
                    switch (element) {
                        ...
                        case 'R':
                            ...
                            break;
                        case 'P': //Lina: new element for Trap, hurting sprite
                            environment.add(new SolidSprite(columnNumber * imageTrapWidth,
                                    lineNumber * imageTrapHeight, imageTrap, imageTrapWidth, imageTrapHeight,-10, false));
                            break;
                        case 'E': //Lina: new element for Trap, hurting sprite
                            environment.add(new SolidSprite(columnNumber * imageDoorWidth,
                                    lineNumber * imageDoorHeight, imageDoor, imageDoorWidth, imageDoorHeight,0, true));
                            break;
                    }
                    columnNumber++;
                }
